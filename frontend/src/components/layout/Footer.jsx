        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-neutral-400 text-sm">
              Your AI-powered healthcare companion — chat, diagnose, and connect with top doctors instantly.
            </p>
            {/* Social Icons */}
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/doctors" className="text-neutral-400 hover:text-primary transition-colors">
                  Find Doctors
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/for-doctors" className="text-neutral-400 hover:text-primary transition-colors">
                  Join as Doctor
                </Link>
              </li>
              <li>

    ...
    <div className="min-h-screen bg-neutral-50 py-12">
      <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            {!editing && (
              <button
                ...
                className="px-4 py-2 border border-primary text-primary rounded-lg hover:bg-primary-50 transition-colors font-medium"
              >
                Edit Profile
              </button>
            )}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="md:col-span-2">
                ...
                <input
                  ...
                  disabled={!editing}
                  className="w-full px-4 py-3 border border-neutral-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent disabled:bg-neutral-100 disabled:text-neutral-600"
                  required
                />
              </div>
              ...
              <div className="md:col-span-2">
                ...
                <input
                  ...
                  disabled
                  className="w-full px-4 py-3 border border-neutral-300 rounded-lg bg-neutral-100 text-neutral-600"
                />
            ...
            {editing && (
              <div className="flex gap-4">
                <button
                  type="submit"
                  disabled={loading}
                  className="flex-1 bg-primary text-white py-3 rounded-lg hover:bg-primary-400 transition-colors font-medium disabled:opacity-50"
                >
                ...
                <button
                  ...
                  className="flex-1 border border-neutral-300 text-neutral-700 py-3 rounded-lg hover:bg-neutral-50 transition-colors font-medium"
                >
                  Cancel
                </button>
              </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm p-8">
          <div className="flex items-center justify-between mb-6">
            <div>
              <h2 className="text-2xl font-bold text-neutral-900">Password & Security</h2>
              <p className="text-neutral-600 text-sm mt-1">Update your password to keep your account secure</p>
            </div>
            {!changingPassword && (
              <button

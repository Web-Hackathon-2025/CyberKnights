      ...
      <div className="min-h-screen flex items-center justify-center bg-linear-to-br from-primary-50 to-white px-4">
        <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8">
          <div className="text-center">
            ...
            <div className="space-y-3 text-sm text-neutral-600 text-left bg-neutral-50 rounded-lg p-4 mb-6">
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-linear-to-br from-primary-50 to-white px-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8">
        ...
        {error && (
          <div className="mb-4 p-4 bg-error-50 border border-error-200 text-error-800 rounded-lg text-sm">
            {error}
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-primary text-white py-3 rounded-lg hover:bg-primary-400 transition-colors font-medium disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {loading ? (
        ...
        <div className="mt-6 text-center">
          <Link to="/login" className="text-sm text-primary hover:text-primary-400 font-medium">
            ← Back to Login
          </Link>
        </div>
      </div>
